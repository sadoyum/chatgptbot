...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6057477624:AAEKTC6rrpbGHNrDDScGfT1q06agbyWP4no"
else:
    tgkey = tgenv
print(tgenv)
